...
### LibreOffice macro side effects (important)
...
- Recommended: use the default (isolated profile enabled)
- Debug: use `--keep-profile` to keep the temporary profile directory
- Legacy behavior: use `--no-isolated` to write into your normal LibreOffice profile
